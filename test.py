...
class WebsiteTasks(TaskSet):
    ...
    def index(self):
        ...
        titles = ["Orion Mars-mission launch delayed for 24 hours - Technology & Science - CBC", "Rob ford dies", "Jian Makes a cake", "Sarah Fulford's is cool","YAY " ,'Mansbridge LUVs FTW']
